...
material::material()
    :color_data(color(1.0f,1.0f,1.0f)),
      ...
      refraction_data(0.0f)
{}

material::material(color const& color_param,
                   shading_parameter const& shading_param,
                   float const reflection_param, float const refraction_param)
    :color_data(color_param),shading_data(shading_param),reflection_data(reflection_param),refraction_data(refraction_param)
{
